...
var _solve_problem = Module['_solve_problem'] = makeInvalidEarlyAccess('_solve_problem');
var _enumerate_answers_problem = Module['_enumerate_answers_problem'] = makeInvalidEarlyAccess('_enumerate_answers_problem');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['solve_problem'] != 'undefined', 'missing Wasm export: solve_problem');
  _solve_problem = Module['_solve_problem'] = createExportWrapper('solve_problem', 2);
  assert(typeof wasmExports['enumerate_answers_problem'] != 'undefined', 'missing Wasm export: enumerate_answers_problem');
  _enumerate_answers_problem = Module['_enumerate_answers_problem'] = createExportWrapper('enumerate_answers_problem', 3);
